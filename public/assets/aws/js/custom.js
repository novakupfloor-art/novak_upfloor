jQuery(document).ready(function($) {
	...
	$(window).scroll(function(){
		if ($(window).scrollTop() >= 40) {
			$('.topnavbar').addClass('fixed-header');
			$('.topnavbar .topnavtitle').addClass('visible-title');
		}
		else {
			$('.topnavbar').removeClass('fixed-header');
			$('.topnavbar .topnavtitle').removeClass('visible-title');
		}
	});
