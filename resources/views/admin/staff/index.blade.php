...
<div class="row">
  <div class="col-md-4">
    <div class="input-group">
      ...
      <select name="id_kategori_staff" class="form-control form-control-sm" style="display:none;">
        ...
        <tbody>
          ...
          <?php $i=1; foreach($staff as $staff) { ?>
            ...
            <tr class="odd gradeX">
              ...
              <td><?php echo $staff->nama_provinsi ?></td>
              <td><?php echo $staff->nama_kabupaten ?></td>
              <td><a href="{{ asset('admin/staff/status_staff/'.$staff->status_staff) }}"><?php echo $staff->status_staff ?></a></td>
